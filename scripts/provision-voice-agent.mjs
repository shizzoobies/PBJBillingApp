      ...
      api_schema: {
        ...
        request_body_schema: {
          ...
          properties: {
            ...
            // user) — NOT generated by the model. Lets the webhook park
            // memory/actions/reports under the actual caller.
            caller_id: {
              type: 'string',
              description: 'The signed-in user id (auto-filled; do not generate).',
