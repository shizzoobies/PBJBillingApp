    ...
    tool_config: {
      ...
      api_schema: {
        ...
        request_body_schema: {
          type: 'object',
          properties: {
            // Auto-filled from the user_id dynamic variable (the signed-in
            // user) — NOT generated by the model. A dynamic-variable property
            // must set ONLY dynamic_variable (no description). Lets the webhook
            // park memory/actions/reports under the actual caller.
            caller_id: {
              type: 'string',
