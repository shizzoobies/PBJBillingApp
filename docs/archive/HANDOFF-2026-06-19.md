> # ⚠️ ARCHIVED — DO NOT USE AS CURRENT STATE
>
> This is the **2026-06-19** handoff. It lived at the repo root until
> 2026-07-26, where it was a trap: anything below about "current state",
> architecture, process or open work is **out of date by over a month**.
>
> **The live handoff is [`docs/HANDOFF.md`](../HANDOFF.md).** Read that one.
>
> Kept because two things here were never carried forward and are still
> useful: the **Env vars (Railway) inventory** below, and the
> **2026-06-10 → 06-19 shipped logs**. Treat everything else as history.
>
> ✅ **Already resolved, do not redo:** the Env vars section below asks for the
> `ELEVENLABS_API_KEY` to be rotated after it was pasted into a chat during
> setup. Alex confirmed on 2026-07-26 that this **has been done**.
