 ...
 * matches it (`turnText`, optional — M1). Returns the spec-shaped patch, or
 * null when nothing usable is left.
 */
export function validateProposalPatch(patch, catalog, turnText = '') {
      ...
      (parsed) => {
        ...
        return {
          ...
          value: {
            ...
            patch: validateProposalPatch(parsed?.patch, ctx.catalog, text),
          },
        }
      },
      {
