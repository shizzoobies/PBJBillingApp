 ...
 * (lib/payroll-cost.js `laborCost`: minutes grouped per person, rounded once
 * to the cent, full-mode group slices counted once) — the same call the
...
export function clientProfitability(data, { month, costRates = {}, lowRealizationThreshold = 50 }) {
  ...
  for (const client of clients) {
    ...
    // and rounded once to the cent, a full-mode group's slices counted once.
