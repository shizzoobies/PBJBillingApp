 ...
 */
export function findBlockingWeek(entryWeekStart, priorWeekStarts, submissions, lockedPeriods) {
  return listBlockingWeeks(entryWeekStart, priorWeekStarts, submissions, lockedPeriods)[0] ?? null
}
 ...
 */
export function listBlockingWeeks(entryWeekStart, priorWeekStarts, submissions, lockedPeriods) {
