...
export function findBlockingWeek(entryWeekStart, priorWeekStarts, submissions) {
  return listBlockingWeeks(entryWeekStart, priorWeekStarts, submissions)[0] ?? null
}
 ...
 */
export function listBlockingWeeks(entryWeekStart, priorWeekStarts, submissions) {
