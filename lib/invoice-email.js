...
export const BRAND_EMAIL_COPY = {
  ...
  quoteAlt: 'Spread success, not stress, thanks for choosing PB&J Strategic Accounting.',
}
...
function lineRows(invoice) {
  return renderedInvoiceLines(invoice.lineItems)
    .map((line) => {
...
export function buildInvoiceEmail({
  ...
  const text = [
    ...
    '',
    ...renderedInvoiceLines(invoice.lineItems).map(
