...
describe('buildInvoicePdf', () => {
  ...
  /*
   * The terms line states the window the invoice was DATED by, not the stored
   * wording. Sixteen client records say "Due on receipt"; printing that beside
   * a due date thirty days out would contradict the document's own date, and
   * printing it beside the OLD due date was worse — the invoice arrived past due.
   */
  it('prints the firm window for a client whose record says "Due on receipt"', async () => {
    ...
    expect(text).toContain('Payment terms: Net 30')
